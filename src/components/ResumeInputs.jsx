...
function ResumeInputs({ resumeDetails, setResumeDetails }) {
        ...
        return (
          <div>
            <p>
              ...
              Once the form get submitted, user won't get the chance to update the details. If you want to proceed please click the <b> Generate AI Skills & Summary</b>  button
            </p>
          </div>
        );
        break;
  ...
  const handleSaveResume = async () => {
    ...
    if (
      ...
      toast.warning("Please fill the form completing!!!")
    }
  };
